  ...
  const fetchCustomersAndManagers = async () => {
    try {
      ...
      const hasPermissionError = 
        companiesResult.error?.code === '42501' || 
        managersResult.error?.code === '42501';

      if (hasPermissionError) {
        logger.warn('Database permission error, using fallback data');
        
        // Use fallback data when permission is denied
        const fallbackCustomers = [
          { id: 'demo-1', full_name: 'Demo Company A', company_name: 'Demo Company A', logo_url: null },
          { id: 'demo-2', full_name: 'Demo Company B', company_name: 'Demo Company B', logo_url: null },
          { id: 'demo-3', full_name: 'Test Client', company_name: 'Test Client', logo_url: null }
        ];
        
        const fallbackManagers = [
          { id: 'demo-mgr-1', full_name: 'John Manager' },
          { id: 'demo-mgr-2', full_name: 'Jane Supervisor' },
          { id: 'demo-mgr-3', full_name: 'Admin User' }
        ];
        ...
        toast({
          ...
          description: "Database permissions are limited. Using demo data for testing.",
        });
        return;
      }

      // Original error handling for other types of errors
      ...
      // Provide minimal fallback data even for unexpected errors
      const emergencyFallback = [
        { id: 'fallback-1', full_name: 'Default Company', company_name: 'Default Company', logo_url: null }
      ];
      const emergencyManager = [
        { id: 'fallback-mgr-1', full_name: 'Default Manager' }
      ];
