...
ADD COLUMN cc_client_ids UUID[] DEFAULT '{}',
ADD COLUMN cc_user_ids UUID[] DEFAULT '{}';
...
CREATE INDEX idx_projects_cc_client_ids ON projects USING GIN (cc_client_ids);
CREATE INDEX idx_projects_cc_user_ids ON projects USING GIN (cc_user_ids);
