-- Drop existing crew_assignments table and recreate with proper relationships
DROP TABLE IF EXISTS crew_assignments CASCADE;

-- Create crew_assignments table with proper relationships
...
-- Create trigger for managing crew assignments
