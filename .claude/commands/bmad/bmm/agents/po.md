...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*assess-project-ready" validate-workflow="/Users/baito.kevin/Downloads/dev/BMAD-METHOD/Baito/Baito-AI/bmad/bmm/workflows/3-solutioning/workflow.yaml">Validate if we are ready to kick off development</item>
